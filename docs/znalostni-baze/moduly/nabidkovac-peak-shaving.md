...
- **Návratnost ≠ celková úspora.** Do návratnosti se počítá jen **přínos baterie** proti optimalizované RK; „audit RK zdarma" je prodejní bonus, který klient dostane i bez investice. **Nabídka pro zákazníka to od 26. 7. 2026 rozepisuje** („Úspora úpravou rezervace (bez investice)" + „Úspora díky baterii" + „Roční úspora celkem"), aby si dopočet zákazníka a uvedená návratnost neodporovaly – dřív ukazovala jen celkovou úsporu vedle návratnosti z přínosu baterie, což dávalo rozdíl až 19×.
- **Úspora bez investice nemůže být záporná** (revize 26. 7. 2026). Optimalizace RK se počítá s rezervou (default 5 %), dnešní stav bez ní – u klienta s úsporně sjednanou RK proto vycházela optimalizace dražší. Baseline je nově „to lepší z dnešního a optimalizovaného stavu“ a příznak `optimalizace_rk_pomuze` říká, jestli má přejednání RK vůbec smysl.
- **Modely 2026 a 2027 mají stejný jmenovatel** (revize 26. 7. 2026) – oba počítají návratnost z přínosu baterie proti symetrické baseline, takže se dají porovnat. Dřív bral rok 2027 celkovou úsporu proti dnešnímu RP.
- **Nová roční RK může být nižší než sražená špička** – v nejsilnějších měsících se k roční rezervaci dokupuje měsíční, což je levnější než držet vysokou rezervaci celý rok. Nabídka i graf teď uvádějí počet takových měsíců, aby to nevypadalo jako chyba návrhu.
- **Nákupní vs. prodejní cena baterie** (revize 26. 7. 2026). Ceník BESS má nákupní (dealer) cenu ve sloupci ceny a doporučenou prodejní ve vlastním sloupci katalogu (`doporucena_cena_kc`), marže je 10 % z prodejní. **Klient investuje prodejní cenu**, takže z ní jde investice v nabídce, návratnost, NPV i práh doporučení. Panel obchodníkovi navíc ukazuje nákupní cenu a marži – do nabídky pro zákazníka se nedostanou (whitelist). Když v katalogu prodejní cena chybí (velké konfigurace 2 MW+), použije se nákupní a marže je nulová. Dřív se všude počítalo z nákupní ceny, takže nabídka slibovala návratnost o ~11 % lepší, než klient dostane.
